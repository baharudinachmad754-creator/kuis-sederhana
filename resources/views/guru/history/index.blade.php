...
<div class="wrapper">
    <div class="card">
        ...
        <div class="header">
            ...
            <h1>History Quiz Guru 📊</h1>
            <p>Pilih mata pelajaran untuk melihat history quiz</p>
        </div>

        <div class="grid">
            @forelse($categories as $category)
                <a href="{{ route('guru.history.quizzes', $category->id) }}" class="mapel">
                    <span class="badge">History</span>
                    <h3>{{ $category->name }}</h3>
                    <p>Lihat quiz & riwayat siswa</p>
                </a>
            @empty
