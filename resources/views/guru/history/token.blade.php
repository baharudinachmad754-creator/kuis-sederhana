...
button:hover {
    ...
    box-shadow: 0 18px 36px rgba(99,102,241,.55);
}
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="header">
            <div class="logo">🔐</div>
            <h1>Verifikasi Token Quiz</h1>
            <p>Masukkan token untuk melihat history siswa</p>
        </div>

        <form method="POST" action="{{ route('guru.history.verify', $quiz->id) }}">
            @csrf

            <div class="form-group">
                <input type="text" name="token" placeholder="Masukkan token quiz" required>
            </div>
